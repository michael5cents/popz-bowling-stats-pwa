...
assert.equal(latest.version,'public-v28');
assert.match(app,/APP_VERSION='public-v28'/);
assert.match(sw,/SW_VERSION='public-v28'/);
assert.match(sw,/popz-bowling-public-v28/);
