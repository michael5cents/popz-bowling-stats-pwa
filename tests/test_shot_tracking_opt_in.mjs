...
assert.equal(latest.version,'public-v32');
assert.match(app,/APP_VERSION='public-v32'/);
assert.match(sw,/SW_VERSION='public-v32'/);
assert.match(sw,/popz-bowling-public-v32/);
