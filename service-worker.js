const CACHE='popz-bowling-public-v6';
const ASSETS=['./','./index.html','./style.css?v=6','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=6','./icon-512.png?v=6','./apple-touch-icon.png?v=6'];
