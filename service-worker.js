const CACHE='popz-bowling-public-v4';
const ASSETS=['./','./index.html','./style.css?v=4','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=4','./icon-512.png?v=4','./apple-touch-icon.png?v=4'];
