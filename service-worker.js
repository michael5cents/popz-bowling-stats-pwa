const CACHE='popz-bowling-public-v20';
const ASSETS=['./','./index.html','./style.css?v=20','./app.js?v=20','./scoring.mjs?v=20','./history.mjs?v=20','./transfer.mjs?v=20','./update.mjs?v=20','./manifest.webmanifest','./icon-192.png?v=20','./icon-512.png?v=20','./apple-touch-icon.png?v=20'];
