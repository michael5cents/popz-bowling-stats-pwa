const CACHE='popz-bowling-public-v14';
const ASSETS=['./','./index.html','./style.css?v=14','./app.js','./scoring.mjs','./transfer.mjs','./manifest.webmanifest','./icon-192.png?v=14','./icon-512.png?v=14','./apple-touch-icon.png?v=14'];
