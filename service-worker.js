const CACHE='popz-bowling-public-v1';
const ASSETS=['./','./index.html','./style.css?v=1','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=1','./icon-512.png?v=1','./apple-touch-icon.png?v=1'];
