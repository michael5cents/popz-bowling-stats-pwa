const CACHE='popz-bowling-public-v9';
const ASSETS=['./','./index.html','./style.css?v=9','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=9','./icon-512.png?v=9','./apple-touch-icon.png?v=9'];
