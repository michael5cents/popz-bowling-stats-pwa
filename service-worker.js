const CACHE='popz-bowling-public-v12';
const ASSETS=['./','./index.html','./style.css?v=12','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=12','./icon-512.png?v=12','./apple-touch-icon.png?v=12'];
