const CACHE='popz-bowling-public-v17';
const ASSETS=['./','./index.html','./style.css?v=17','./app.js','./scoring.mjs','./history.mjs','./transfer.mjs','./update.mjs','./manifest.webmanifest','./icon-192.png?v=17','./icon-512.png?v=17','./apple-touch-icon.png?v=17'];
