const CACHE='popz-bowling-public-v8';
const ASSETS=['./','./index.html','./style.css?v=8','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=8','./icon-512.png?v=8','./apple-touch-icon.png?v=8'];
