const CACHE='popz-bowling-public-v16';
const ASSETS=['./','./index.html','./style.css?v=16','./app.js','./scoring.mjs','./transfer.mjs','./update.mjs','./manifest.webmanifest','./icon-192.png?v=16','./icon-512.png?v=16','./apple-touch-icon.png?v=16'];
