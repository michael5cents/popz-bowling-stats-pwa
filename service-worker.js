const CACHE='popz-bowling-public-v2';
const ASSETS=['./','./index.html','./style.css?v=2','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=2','./icon-512.png?v=2','./apple-touch-icon.png?v=2'];
