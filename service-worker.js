const CACHE='popz-bowling-public-v13';
const ASSETS=['./','./index.html','./style.css?v=13','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=13','./icon-512.png?v=13','./apple-touch-icon.png?v=13'];
