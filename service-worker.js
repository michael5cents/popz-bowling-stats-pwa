const CACHE='popz-bowling-public-v5';
const ASSETS=['./','./index.html','./style.css?v=5','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=5','./icon-512.png?v=5','./apple-touch-icon.png?v=5'];
