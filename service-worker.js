const CACHE='popz-bowling-public-v10';
const ASSETS=['./','./index.html','./style.css?v=10','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=10','./icon-512.png?v=10','./apple-touch-icon.png?v=10'];
