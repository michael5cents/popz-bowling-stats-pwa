const CACHE='popz-bowling-public-v3';
const ASSETS=['./','./index.html','./style.css?v=3','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=3','./icon-512.png?v=3','./apple-touch-icon.png?v=3'];
