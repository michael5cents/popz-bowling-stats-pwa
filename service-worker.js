const CACHE='popz-bowling-public-v7';
const ASSETS=['./','./index.html','./style.css?v=7','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=7','./icon-512.png?v=7','./apple-touch-icon.png?v=7'];
