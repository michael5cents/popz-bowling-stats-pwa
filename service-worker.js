const CACHE='popz-bowling-public-v11';
const ASSETS=['./','./index.html','./style.css?v=11','./app.js','./scoring.mjs','./manifest.webmanifest','./icon-192.png?v=11','./icon-512.png?v=11','./apple-touch-icon.png?v=11'];
