const CACHE='popz-bowling-public-v19';
const ASSETS=['./','./index.html','./style.css?v=19','./app.js','./scoring.mjs','./history.mjs','./transfer.mjs','./update.mjs','./manifest.webmanifest','./icon-192.png?v=19','./icon-512.png?v=19','./apple-touch-icon.png?v=19'];
